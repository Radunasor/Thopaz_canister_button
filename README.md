...
### Button Design
![Button Design](./images/top.png)
### Button attched
![Button Design](./images/canister_attached.png)

### Button Removal Process
1. Grip the button:

    ![Grip the front bottom](./images/without_canister.png)
2. Pull outward:

    ![Pull Outward](./images/pulled_out.png)